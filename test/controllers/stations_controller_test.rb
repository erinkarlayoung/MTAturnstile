...
class StationsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create station" do
    assert_difference('Station.count') do
      post stations_url, params: { station: { accessible: @station.accessible, borough: @station.borough, name: @station.name, neighborhood: @station.neighborhood, train: @station.train } }
    end
  ...
  test "should update station" do
    patch station_url(@station), params: { station: { accessible: @station.accessible, borough: @station.borough, name: @station.name, neighborhood: @station.neighborhood, train: @station.train } }
